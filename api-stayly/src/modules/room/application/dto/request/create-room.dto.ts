/**
 * CreateRoomDto
 * Request DTO for creating a homestay room
 */
...
export class CreateRoomDto {
  ...
  guestCapacity: GuestCapacityDto;
  ...
  @ApiProperty({
    description: "Room images (2-10 images required for homestay)",
    type: [RoomImageDto],
  })
  @IsArray()
  ...
  @ApiProperty({
    description: "Base price (optional)",
    required: false,
  })
  @IsOptional()
  @ValidateNested()
