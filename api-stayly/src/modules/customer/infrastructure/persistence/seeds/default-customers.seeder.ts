/**
 * DefaultCustomersSeeder provisions sample customer accounts
 */
...
@Injectable()
export class DefaultCustomersSeeder implements OnModuleInit {
  private readonly logger = new Logger(DefaultCustomersSeeder.name);
